...
<div dir="rtl">
זה קשה. זה תמיד קשה כשעושים משהו בפעם הראשונה. במיוחד כאשר משתפים פעולה, לא נעים לעשות טעויות. רצינו להקל על הדרך שבה משתמשים התורמים בפעם הראשונה לומדים ועושים את הצעד הראשון.
קריאת כתבות וצפייה בסרטוני הדרכה יכולים לעזור, אבל מה יותר טוב מאשר לבצע את הדברים בסביבת למידה? המטרה של הפרויקט הזה היא לתת הכוונה ולפשט את הדרך שבה תורמים מתחילים מבצעים את התרומה הראשונה שלהם. אם אתם מחפשים לבצע את התרומה הראשונה שלכם, עקבו אחרי הצעדים למטה.
</div>

<div dir="rtl">
<h4> אם פחות נוח לכם להשתמש בטרמינל, כאן יש קישור תוך שימוש בכלים גרפיים
...
<div dir="rtl">
<h2> מחקו את הענף שלכם אחרי שבקשת המשיכה אושרה </h2>
</div>
